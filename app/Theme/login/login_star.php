...
<head>
  ...
  <title>Star Login Template</title>
  <!-- plugins:css -->
      ...
      <div class="content-wrapper d-flex align-items-center auth auth-bg-1 theme-one">
        <div class="row w-100">
          <div class="col-lg-4 mx-auto">
              ...
              <form method="" action="#">
                ...
                <div class="form-group">
                  <button class="btn btn-block g-login">
                    <img class="mr-3" src="<?= BASE_URL ?>theme/staradmin/images/file-icons/icon-google.svg" alt="">Log in with Google</button>
                </div>
            ...
            <p class="footer-text text-center">copyright © <?php echo getyear() ?> Bootstrapdash. All rights reserved.</p>
          </div>
        </div>
      </div>
